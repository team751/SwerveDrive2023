...
public class Gyro {
    ...
    public double[] getAccelerationAngle() {
        ...
        data[0] = 180 / Math.PI * Math.atan(data[0] / Math.sqrt(data[1] * data[1] + data[2] * data[2]));
        data[1] = 180 / Math.PI * Math.atan(data[1] / Math.sqrt(data[0] * data[0] + data[2] * data[2]));
        data[2] = 180 / Math.PI * Math.atan(Math.sqrt(data[0] * data[0] + data[1] * data[1]) / data[2]);
        SmartDashboard.putNumber("angleX", data[0]);
        SmartDashboard.putNumber("angleY", data[1]);
