...
public class SwerveDrive extends SubsystemBase {
    ...
    public void drive(double speedMetersPerSecond, double directionRadians, double rotationRadiansPerSecond) {
        ...
        SwerveModuleState.optimize(frontRightState,
                new Rotation2d(Units.radiansToDegrees(frontRight.currentWheelAngleRadians)));
        SwerveModuleState.optimize(frontLeftState,
                new Rotation2d(Units.radiansToDegrees(frontLeft.currentWheelAngleRadians)));

        SwerveModuleState.optimize(backRightState,
                new Rotation2d(Units.radiansToDegrees(backRight.currentWheelAngleRadians)));
        SwerveModuleState.optimize(backLeftState,
                new Rotation2d(Units.radiansToDegrees(backLeft.currentWheelAngleRadians)));
        ...
        if (speedMetersPerSecond < 0.1 && rotationRadiansPerSecond < 0.1) {
            ...
            backLeft.setSpeed(0);
            frontRight.setSpinSpeed(0);
            frontLeft.setSpinSpeed(0);
            backRight.setSpinSpeed(0);
            backLeft.setSpinSpeed(0);
            return;
        }
