...
public class Gyro {
    ...
    public double[] getAccelerationAngle() {
        ...
        data[0] = 180 / Math.PI * Math.atan2(data[0], Math.sqrt(Math.pow(data[1], 2) + Math.pow(data[2], 2)));
        data[1] = 180 / Math.PI * Math.atan2(data[1], Math.sqrt(Math.pow(data[0], 2) + Math.pow(data[2], 2)));
