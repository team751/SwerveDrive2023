...
public class Gyro {
    ...
    public double[] getAccelerationAngle() {
        ...
        data[0] = Math.PI / 180 * Math.atan(data[0] / Math.sqrt(data[1] * data[1] + data[2] * data[2]));
        data[1] = Math.PI / 180 * Math.atan(data[1] / Math.sqrt(data[0] * data[0] + data[2] * data[2]));
        data[2] = Math.PI / 180 * Math.atan(Math.sqrt(data[0] * data[0] + data[1] * data[1]) / data[2]);
