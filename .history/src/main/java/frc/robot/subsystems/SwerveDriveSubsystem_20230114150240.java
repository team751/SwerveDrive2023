...
public class SwerveDriveSubsystem extends SubsystemBase {
  ...
  public SwerveDriveSubsystem(int driveID, int spinID) {
    ...
    pidController = new PIDController(SmartDashboard.getNumber("Proportion", Constants.pidDefaultValue), 0, 0);
  ...
  public void periodic() {
    ...
    currentWheelAngleRadians = (encoder.getPosition() / Constants.gearRatio) * (2 * Math.PI) % (2 * Math.PI);
  }
