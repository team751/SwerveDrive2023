...
public class SwerveDrive extends SubsystemBase {
    ...
    public void drive(double speedMetersPerSecond, double directionRadians, double rotationRadians) {
        double vx = speedMetersPerSecond * Math.cos(directionRadians);
        double vy = speedMetersPerSecond * Math.sin(directionRadians);

        ChassisSpeeds speeds = new ChassisSpeeds(vx, vy, rotationRadians);
    }
