...
public class SwerveDrive extends SubsystemBase {
    ...
    public void drive(double speedMetersPerSecond, double directionRadians, double rotationRadiansPerSecond) {
        ...
        if (SmartDashboard.getBoolean("Front Right Motor", false)) {
            ...
            SmartDashboard.putNumber("FRCurrentWheelAngleDegrees",
        ...
        if (SmartDashboard.getBoolean("Front Left Motor", false)) {
            ...
            SmartDashboard.putNumber("FLWheelAngleDegrees",
                    Units.radiansToDegrees(frontLeft.currentWheelAngleRadians));
        }
        if (SmartDashboard.getBoolean("Back Right Motor", false)) {
            ...
            SmartDashboard.putNumber("BRWheelAngleDegrees",
                    Units.radiansToDegrees(backRight.currentWheelAngleRadians));
        }
        if (SmartDashboard.getBoolean("Back Left Motor", false)) {
            ...
            SmartDashboard.putNumber("BLWheelAngleDegrees",
