...
public class SwerveDriveModule extends CommandBase {
    private static SwerveDriveSubsystem frontLeftSub;
    private static SwerveDriveSubsystem backLeftSub;
    private static SwerveDriveSubsystem backRightSub;
    private static SwerveDriveSubsystem frontRightSub;
