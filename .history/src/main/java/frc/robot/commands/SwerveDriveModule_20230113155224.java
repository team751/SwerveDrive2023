...
public class SwerveDriveModule extends CommandBase {
    private final SwerveDriveSubsystem frontLeftSub;
    private final SwerveDriveSubsystem backLeftSub;
    private final SwerveDriveSubsystem backRightSub;
    private final SwerveDriveSubsystem frontRightSub;
