...
public class SwerveDriveModule extends CommandBase {
    private static final SwerveDriveSubsystem frontLeftSub;
    private static final SwerveDriveSubsystem backLeftSub;
    private static final SwerveDriveSubsystem backRightSub;
    private static final SwerveDriveSubsystem frontRightSub;
  ...
  public void initialize() {
    ...
    backLeftSub.follw(frontLeftSub);
  }
