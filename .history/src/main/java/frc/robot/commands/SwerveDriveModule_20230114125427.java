...
public class SwerveDriveModule extends CommandBase {
  ...
  @Override
  public void execute() {
    float speed = (float) Constants.driverStick.getLeftX() * 0.5f;
    float spin = (float) Constants.driverStick.getLeftY() * -0.5f;
    float angle = (float) Constants.driverStick.getRightX();
