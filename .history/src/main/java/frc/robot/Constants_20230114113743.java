...
public final class Constants {
    ...
    public static final Translation2d frontLeftOffsetMeters = new Translation2d(-motorXOffsetInches,
            motorYOffsetInches);
    public static final Translation2d backLeftOffsetMeters = new Translation2d(-motorXOffsetInches,
            -motorYOffsetInches);
