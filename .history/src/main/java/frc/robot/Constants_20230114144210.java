...
public final class Constants {
    ...
    public enum DriveID {
        FRONT_RIGHT(10), FRONT_LEFT(16), BACK_LEFT(12), BACK_RIGHT(14);
    ...
    public enum SpinID {
        FRONT_RIGHT(11), FRONT_LEFT(17), BACK_LEFT(13), BACK_RIGHT(15);
    ...
    /* Motor maximum speed */
    public static double motorMaxSpeedMetersPerSecond = 5.0f;
    public static double spinMotorMaxSpeedMetersPerSecond = 10.0f;
