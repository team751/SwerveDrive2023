...
public final class Constants {
    ...
    public static Translation2d frontRightOffsetInches = new Translation2d(motorXOffsetInches, motorYOffsetInches);
    public static Translation2d frontLeftOffsetInches = new Translation2d(-motorXOffsetInches, motorLengthApartInches);
    public static Translation2d backLeftOffsetInches = new Translation2d(-motorXOffsetInches, -motorLengthApartInches);
