...
public final class Constants {
    ...
    public static Translation2d frontLeftOffsetInches = new Translation2d(motorWidthApartInches/2, motorLengthApartInches/2)
    public static Translation2d frontRightOffsetInches = new Translation2d(motorWidthApartInches/2 * , motorLengthApartInches/2 * )
    public static Translation2d frontLeftOffsetInches = new Translation2d(motorWidthApartInches/2 * , motorLengthApartInches/2 * )
    public static Translation2d frontLeftOffsetInches = new Translation2d(motorWidthApartInches/2 * , motorLengthApartInches/2 * )
